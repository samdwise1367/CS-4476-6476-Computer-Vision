...
if ~exist('feature_pos.mat', 'file')
    fprintf('No existing positive features found. Computing one from training images\n')
    features_pos = get_positive_features( train_path_pos, feature_params );
    save('feature_pos.mat','features_pos')
else
    load('feature_pos.mat','features_pos')
end

if ~exist('feature_neg.mat','file')
    ...
    save('feature_neg.mat','features_neg')
else
    load('feature_neg.mat','features_neg')
end 
...
if ~exist('hardMining.mat','file')
        ...
        save('hardMining.mat','features_neg','dataset','labels','w','b')
    else
        load('hardMining.mat','features_neg','dataset','labels','w','b')
end
...
if ~exist('detector.mat','file')
    [features, bboxes, confidences, image_ids] = run_detector(test_scn_path, w, b, feature_params, false);
    %[bboxes, confidences, image_ids] = run_detector(test_scn_path, w, b, feature_params);
    save('detector.mat','bboxes','confidences','image_ids');
else 
    load('detector.mat','bboxes','confidences','image_ids');
end
